...
import com.yizhaoqi.insightvault.handler.ChatWebSocketHandler;
import com.yizhaoqi.insightvault.service.ChatHandler;
 ...
 * 聊天控制器。
 *
 * 负责处理 WebSocket 文本消息，并提供获取 WebSocket 停止指令的 REST 接口。
 */
@Component
@RestController
